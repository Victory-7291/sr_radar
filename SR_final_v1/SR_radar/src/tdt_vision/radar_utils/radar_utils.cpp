...
namespace tdt_radar
{
    ...
    parser::parser()
    {
        ...
        points_map["Center_Highland"]         = new Parser_Points("Center_Highland");
        points_map["Self_Highland"]        = new Parser_Points("Self_Highland");
        points_map["Enemy_Highland"]    = new Parser_Points("Enemy_Highland");
